<%-- 
    Document   : venue
    Created on : May 2, 2020, 2:12:26 AM
    Author     : kavii
--%>
...
.checked {
  ...
  <%-- Navbar end --%>
                ...
                <div class="card" >
                        <img class="card-img-top" src="images/img55.jpg" alt="Card image cap" style="height:20%;">
                        <div class="top-left">
             ...
             <div class="card-deck">
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                    <img class="card-img-top" src="images/img57.jpg" alt="Card image cap" style="height:40%;">
                        <div class="card-body">
                          <h5 class="card-title">Mountain side Hotels</h5>
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img56.jpg" alt="Card image cap" style="height:40%;">
                        <div class="card-body">
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img58.jpg" alt="Card image cap" style="height:40%;">
                        <div class="card-body">
                          <h5 class="card-title">Beach side Hotel</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements like text,
            ...
            <div class="card-deck">
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img53.jpg" alt="Card image cap" style="height:40%;">
                        <div class="card-body">
                          <h5 class="card-title">Gardens & Hotels</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements like text,
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img60.jpg" alt="Card image cap" style="height:40%;">
                        <div class="card-body">
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img59.jpg" alt="Card image cap" style="height:40%;">
                        <div class="card-body">
                          <h5 class="card-title">Lake Side Hotels</h5>
                           <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements like text,
