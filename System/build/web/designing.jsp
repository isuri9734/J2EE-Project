<%-- 
    Document   : designing
    Created on : May 2, 2020, 2:11:46 AM
    Author     : kavii
--%>
...
.checked {
  ...
  <%-- Navbar end --%>
                 ...
                 <div class="card" >
                        <img class="card-img-top" src="images/img35.jpg" alt="Card image cap" style="height:20%;">
                        <div class="top-left">
                            <h1>Designing</h1>
             ...
             <div class="card-deck">
               ...
               <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                    <img class="card-img-top" src="images/img32.jpg" alt="Card image cap" style="height:50%;">
                        <div class="card-body">
                          <h5 class="card-title">Tharu Designers</h5>
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img33.jpg" alt="Card image cap" style="height:50%;">
                        <div class="card-body">
                          <h5 class="card-title">Nidhu Creatives</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements like text,
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img31.jpg" alt="Card image cap" style="height:50%;">
                        <div class="card-body">
                          <h5 class="card-title">Shine Designs</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements like text,
            ...
            <div class="card-deck">
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img34.jpg" alt="Card image cap" style="height:50%;">
                        <div class="card-body">
                          <h5 class="card-title">Design Shiny</h5>
                         <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements .
                             </p>
                        </div>
                        <ul class="list-group list-group-flush ">
                          <li class="list-group-item list-group-item-success">
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img38.jpg" alt="Card image cap" style="height:50%;">
                        <div class="card-body">
                          <h5 class="card-title">Devgive</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements.
                ...
                <div class="card card-body text-success" style="width: 18rem; margin: 2%;">
                        <img class="card-img-top" src="images/img37.jpg" alt="Card image cap" style="height:50%;">
                        <div class="card-body">
                          <h5 class="card-title">Nirmani</h5>
                         <p class="card-text">Some quick example text to build on the card title and make up the bulk of 
                              the card's content.Though graphic designers may incorporate art into their work, 
                              the main role of a graphic
                             designer is to visually solve communication problems using design elements.
